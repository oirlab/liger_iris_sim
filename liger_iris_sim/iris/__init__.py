...
def generate_filename(
    ...
    # Format: OBSID-IRIS-DET[X]-OBSTYPLevel-EXP-SUB.fits
...
DEFAULT_HEADER['TELESCOP'] = ('TMT', 'Telescope name')
DEFAULT_HEADER['INSTRUME'] = ('IRIS', 'Instrument name')
DEFAULT_HEADER['DETECTOR'] = ('IMG1', 'Detector name')
